...
A unique coefficient is attributed for each subject (such as Python, SQL, ETL, Dataiku, etc).  
...
def load_template():
    ...
    return df
st.dataframe(load_template(), use_container_width=True)
...
st.markdown("""
            ...
            This page describes the expected knowledges and experiences for each evaluated subject and for each status (junion, intermediate, confirmed, expert).
            """)
